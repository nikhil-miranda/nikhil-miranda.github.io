...
let loadMovieData = (e) => {
    ...
    if (movieTitle != '' && movieTitle != 'undefined' && movieTitle != null){ apiURL = apiURL.concat(`&t=${movieTitle}`); }
    if (movieYear != '' && movieYear != 'undefined' && movieYear != null){ apiURL = apiURL.concat(`&y=${movieYear}`); }
    if (movieId != '' && movieId != 'undefined' && movieId != null){ baseURL = baseURL.concat(`&i=${movieId}`); apiURL = baseURL; }
  ...
  //          console.log("Response Returned: " + response);
            ...
            if (response == "True") {
                ...
                if (data.Poster != "N/A")
                    ...
                    responseData = `<tr><td colspan="2" style="text-align: center;"><img src="${poster}" height="400px"></td></tr>
